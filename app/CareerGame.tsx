...
import { advanceOffseasonWeek, beginOffseason } from "../game/season-flow";
import type {
...
export default function CareerGame({ cloudEnabled = true }: { cloudEnabled?: boolean }) {
  ...
  const finishOffseasonWeek = () => {
    ...
    setCareer({ ...career, offseason: nextOffseason, trainingDone: false, market: salary.market, money: career.money + Math.round(salary.amountEur * 4.3) });
